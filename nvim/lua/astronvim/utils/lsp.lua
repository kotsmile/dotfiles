...
M.on_attach = function(client, bufnr)
  ...
  lsp_mappings.n["<leader>lp"] = { function() vim.diagnostic.goto_prev() end, desc = "Previous diagnostic" }
  lsp_mappings.n["<leader>ln"] = { function() vim.diagnostic.goto_next() end, desc = "Next diagnostic" }
